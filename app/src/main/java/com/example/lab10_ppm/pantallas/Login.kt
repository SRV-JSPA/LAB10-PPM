...
@Composable
fun Login( auth: verifManager, navigation: NavController){
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ClickableText(
            ...
            modifier = Modifier
                ...
                .padding(40.dp),
            onClick = {
                navigation.navigate(Routes.Cusuario.route)
    ...
    Column(
        ...
        Box(modifier = Modifier.padding(40.dp, 0.dp, 40.dp, 0.dp)) {
            Button(
                onClick = {
                    scope.launch {
                        emailPassSignIn(email, contra, auth, context, navigation)
                    }
                },
...
private suspend fun emailPassSignIn(email: String, password: String, auth: verifManager, context: Context, navigation: NavController) {
